...
<div class="container">
    <form action="">
        ...
        <?php }if ($session->get('company_id')){ ?>
            <div class="col-lg-4">
                <input class="form-control" name="companytxtsearch" type="text" value="<?php echo $txtsearch; ?>" placeholder="Search by Product Name" >
            </div>
        <?php } ?>
             <div class="col-lg-4">
                <?php if ($session->get('user_id')){ ?>
                <!-- id="state" -->
                <select name="company_id" class="form-control input-lg single "  >
                    <option value="" class="text-center">- Select Company Name -</option>
                <?php
...
<div class="col-lg-2 text-right bo1"> 
		<div class="form-group">
                                ...
                                <table data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="Percentage" data-sortable="true">Percentage</th>
                                            <?php if($session->get('user_id')){?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th><a href="<?php echo site_url('Products?txtsearch='.$kdata->company_name);?>"><?php echo $kdata->company_name ; ?></a></th>
