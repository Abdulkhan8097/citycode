...
<!--                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
        ...
        <!-------------------------------- search --------------------------->
             ...
             <form action="">
                <div class="row">                   
                    ...
                    <div class="col-lg-3">
                     ...
                     <div class="col-lg-2">
                      <?php $current_version = isset($searchArray['current_version']) ? $searchArray['current_version'] : ""; ?>
                        <select class="form-control" name="current_version">
                            <option value="">-All Version-</option>
                            <?php foreach ($version as $value) { ?>
                                <option value="<?php echo $value['version_no'] ?>"  <?php if ($current_version == $value['version_no']) {
                                echo "selected";
                            } ?>>
                                <?php echo $value['version_no']; ?>
                                </option>
                            <?php } ?>
                        </select>
                    </div>
		  ...
		  <div class="col-lg-3 ">
                     ...
                     <a  href=" <?php echo site_url('Customers?points=1'); ?>" class="btn btn-primary waves-effect waves-light mr-1">
                            Highest Points by user</a>
                           ...
                           <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"  data-sortable="true">City Code</th>
                                        <th class="text-center"  data-sortable="true">VIP Code</th>
                                        <th class="text-center"  data-sortable="true">Full Name</th>
                                        <th class="text-center"  data-sortable="true">Mobile Number</th>
                                        <th class="text-center"  data-sortable="true">Version</th>
                                       <!--  <th class="text-center"  data-sortable="true">App Status</th> -->
                                        <th class="text-center" data-sortable="true">Gender</th>
                                        
                                        <th class="text-center"  data-sortable="true">Governorate</th>
                                        <th class="text-center" data-sortable="true">Point</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        foreach ($customers as $kdata) {
                                            ...
                                            <td class="text-center"><?php echo $kdata->city_code; ?></td>
                                            <td class="text-center"><?php echo $kdata->vip_code; ?></td>
                                            <th class="text-center"><?php if ($kdata->name) {
                                                echo $kdata->name;
                                            ...
                                            <td class="text-center"><?php echo $kdata->current_version; ?></td>
                                         <!--    <td class="text-center"> <?php //if($kdata->app_status=='install')
                                             //{?>
                                                <span class="badge badge-success">Install</span>
                                            <?php //}else{  ?>
                                                <span class="badge badge-danger">Uninstall</span>
                                                 <?php //} ?>


                                                </td> -->
					    <td class="text-center"><?php echo $kdata->gender; ?></td>
					    <td class="text-center">
                                            <?php foreach ($states as $row) {
                                                 if ($row['state_id'] == $kdata->stateid) { 
						 echo $row['state_name'] . ' / ' . $row["arb_state_name"]; } } ?>
				            </td>
					<td class="text-center"><?php echo $kdata->totalpoint; ?></td>
