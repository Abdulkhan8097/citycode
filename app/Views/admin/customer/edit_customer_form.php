                                ...
                                <div class="col-md-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <?php echo $customers->vip_code; ?>
                                            <a href="<?php echo site_url('CustomerController/Deletevipcode?id='.$customers->id); ?>" onClick="return confirm('Are you sure you want to delete this item?');"><i style="color:red" class="fa fa-trash"></i> </a>
                                        </div> 
                                    </div>
                                </div>
                            </div>
