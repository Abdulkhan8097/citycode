...
<div class="page-content">
    ...
    if ($city['city_id'] == $customer->cityid) {
        ...
        <?php echo $city['city_name']; ?> <?php }
                            ...
                            <div class="col-6">
                             ...
                             <div class="col-6">
                                 <blockquote class="card-blockquote mb-0">
                                    <p>Point : <?php echo $customer->totalpoint;?></p>
                                </blockquote></div>
    ...
    if ($city['city_id'] == $customer->cityid) {
        ...
        <?php echo $city['city_arb_name']; ?> <?php }
                            ...
                            <?php if ($customer->current_version): ?>
                                 <div class="col-6">
                                 <blockquote class="card-blockquote mb-0">
                                    <p>Current Version : <?php echo $customer->current_version;?></p>
                                </blockquote></div>
                                
                            <?php endif ?>

                             <?php //if ($customer->app_status): ?>
                             <!--     <div class="col-6">
                                 <blockquote class="card-blockquote mb-0">
                                    <p>App Status : <?php //echo $customer->app_status;?></p>
                                </blockquote></div> -->
