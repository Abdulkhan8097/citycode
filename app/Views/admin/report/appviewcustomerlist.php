...
<div class="page-content">
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-20">Top Purchase Customers</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <?php echo view('admin/report/_searchformview'); ?>
            <!-- Tab panes -->
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                                                ...
                                                <thead>
                                                    <tr>
                                                       <th data-sortable="true">SI. No.</th>
                                                        ...
                                                        <th data-sortable="true">Customer Code</th>
                                                        <th data-sortable="true">Mobile</th>
                                                        <th data-sortable="true">Sex</th>
                                                        <th data-sortable="true">Total View</th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($customers as $kdata) {  ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $kdata->cm_count; ?></td>
                                                            <td><?php echo $kdata->cm_created; ?></td>
