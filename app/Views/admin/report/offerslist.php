                                             ...
                                             <table data-toggle="table" data-striped="true" class="table table-striped table-centered table-nowrap mb-1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-sortable="true">Offer Type</th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($offerslist as $kdata) {  ?>
                                                        <tr>
                                                            ...
                                                            <td>
<!--                                                                <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('ReportDetails?offer_id=' . $kdata['id']); ?>">
