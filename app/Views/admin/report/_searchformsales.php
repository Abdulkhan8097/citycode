                        ...
                        <div class="row ">	                           
                            <div class="col-lg-3 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" name="order_start_date" type="date" value="<?php  echo isset($searchArray['order_start_date']) ? $searchArray['order_start_date'] : "" ?>" placeholder="Search by start date" >
                                    </div>
                                </div>       
                            </div>								
                            ...
                            <div class="col-lg-3 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" name="order_end_date" type="date" value="<?php echo isset($searchArray['order_end_date']) ? $searchArray['order_end_date'] :''; ?>" placeholder="Search by end date" >
                                    </div>
                                </div>       
                            </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-3 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control" name="sales_purchase" >
                                            <option value="">- All -</option>
                                            <option value="top" <?php echo   (isset($searchArray['sales_purchase']) &&  $searchArray['sales_purchase'] =='top') ? "Selected" : ""; ?>> Top Purchase / Sales </option>
                                            <option value="less" <?php echo   (isset($searchArray['sales_purchase']) &&  $searchArray['sales_purchase'] =='less') ? "Selected" : ""; ?>>Less Purchase / Sales</option>
...
<ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php if($method == 'topPurchaseCustomer'){ echo "active"; }?>" onclick="customersearch()" href="javascript::void(0);">Customer</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  <?php if($method == 'topSalesCompany'){ echo "active"; }?>" onclick="companysearch()"   href="javascript::void(0);">Company</a>
                </li>
...
<script>
    ...
    {
        $('#adminsearch').attr('action', "<?php echo site_url('toppurchasecutomers');?>");
         $("#adminsearch").submit();
    }
    
    function companysearch()
    { 
        $('#adminsearch').attr('action', "<?php echo site_url('topsalecompany');?>");
         $("#adminsearch").submit();
    }
