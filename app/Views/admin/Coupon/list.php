        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-20"><?php //echo $title; ?>Coupon Record List</h4>
                </div>
            </div>
              <div class="col-sm-6">
                    <div class="float-right d-none d-md-block">
                        <div class="dropdown">
                            <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('addcoupon'); ?>">
                                <i class="ion ion-md-add-circle-outline"></i> Add Coupon Type
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">                           
                        ...
                        <div class="row ">                             
                            ...
                            <option selected disabled><--Select Status--></option>
                              <option style="color: green;" value="1" <?php echo (isset($searchArray) && !empty($searchArray) && $searchArray['status']=='1') ? 'selected' : ''; ?>>Active</option>
                            
                               <option  style="color: Orange;" value="2" <?php echo (isset($searchArray) && !empty($searchArray) && $searchArray['status']=='2') ? 'selected' : ''; ?>>InActive</option>
                            ...
                            <div class="col-lg-1">
                                ...
                                <div class="col-md-2">
                                    <a href="<?php echo site_url('viewcoupon'); ?>">
                       ...
                       <?php if($pagination["getNbResults"] >0 ){ ?>
                            ...
                            <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"  data-sortable="true">Coupon Amount</th>
                                     
                                        <th class="text-center"  data-sortable="true">Status<br>Status</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        foreach ($list as $kdata) {
                                            ...
                                            <td class="text-center"><?php echo $kdata->coupon_amount;?></td>
                        ...
                        <td class="text-center"><?php echo $kdata->created;?></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('detailscoupon?id=' . $kdata->id); ?>" title="view">
                                          ...
                                          <!--      <a class="btn btn-primary waves-effect waves-light" href="<?php //echo site_url('addcoupon?id=' . $kdata->id); ?>" title="Edit">
                                                ...
                                                <a class="btn btn-danger waves-effect waves-light" href="<?php echo site_url('Coupon/delete?id=' . $kdata->id); ?>" onClick="return confirm('Are you sure you want to delete this item?');" title="Delete">
