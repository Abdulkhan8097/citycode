                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="org_price" class="form-control" placeholder="Original Price" name="original_price" onKeyUp="numericFilter(this, caldicount());" value="<?php echo $product['original_price']?>"; required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        function sum() {
            alert(document.getElementById('discount_offer').value);
            var final_org_amount = 0;
            var txtFirstNumberValue = document.getElementById('org_price').value||0;
            var txtSecondNumberValue = document.getElementById('discount_offer').value||0;
        ...
        var disamt = $(discount_offer).val()||0;
        //document.getElementById('discount_per').value = parseInt(disamt);
//        var orgamt = $(org_price).val()||0;
...
//      alert('in');
        ...
        var result = parseFloat(txtFirstNumberValue)*parseFloat(txtSecondNumberValue)/100;
        final_org_amount =parseFloat(txtFirstNumberValue)-parseFloat(result);
        //alert(document.getElementById('org_price').value);
        if (!isNaN(final_org_amount)) {
            document.getElementById('price').value = final_org_amount.toFixed(3);
        }
    }
