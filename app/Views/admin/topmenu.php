<?php $session = session(); 
    ...
    $OrdersModel = new OrdersModel();   
        ...
        $dataTransaction =$OrdersModel->todayTrasactionCost();
        
        $todayTrasactionCost = $dataTransaction->TodaysSale;
        //print_r($todayTrasactionCost);exit;
?>


<header id="page-topbar">
                <div class="navbar-header" style="background:#F6D000;">
                    <div class="d-flex">
                        <!-- LOGO -->
                        <div class="navbar-brand-box">
                            <a href="<?php echo site_url('dashboard'); ?>" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="<?php echo base_url('admin/images/city-logo.jpg'); ?>" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo base_url('admin/images/city-logo.jpg'); ?>" alt="" height="17">
                                    <!-- Chiusouk -->
                                </span>
                            </a>
                            ...
                            <a href="<?php echo site_url('dashboard'); ?>" class="logo logo-light">
                                <span class="logo-sm text-white">
                                    <img src="<?php echo base_url('admin/images/city-logo.jpg'); ?>" alt="" height="30">
                                    <!-- Chiusouk -->
                                </span>
                                <span class="logo-lg text-white">
                                    <img src="<?php echo base_url('admin/images/city-logo.jpg'); ?>" alt="" height="60">
                                    <!-- Chiusouk -->
                                </span>
                            </a>
                        </div>
                ...
                <?php 
                    if($todayTrasactionCost!='' || $todayTrasactionCost>=500.00){?>
...
<?php } else if ($session->get('company_id')){	?>
                            ...
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!--<img class="rounded-circle header-profile-user" src="<?php echo base_url('admin/images/users/user-4.jpg'); ?>"
                                    alt="Header Avatar">-->  <?php echo ($session->get('company_name')); ?>
                            </button>

<?php } else if ($session->get('employee_id')){	?>
