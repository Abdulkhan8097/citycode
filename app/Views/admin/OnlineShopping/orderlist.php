        ...
        <div class="row align-items-center">
            <div class="col-sm-4">
                <div class="page-title-box">
                    <h4 class="font-size-20"><?php //echo $title; ?> Order List</h4>
                </div>
            </div>
                        ...
                        <div class="row ">                             
                            ...
                            <div class="col-lg-3 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control single" name="product_id" >
                                            
                                                
                                                    <option  value="" >Select Product Name</option>
                                                    <?php   foreach ($product as $row) {  ?>
                                                <option value="<?php echo $row['id'] ?>"   <?php echo   (isset($searchArray['product_id']) && $row['id'] == $searchArray['product_id']) ? "Selected" : ""; ?>>
                                                            <?php echo $row['arb_product_name'] ? $row['product_name'] . ' / ' . $row['arb_product_name'] : $row['product_name']; ?></option> 
                                                 <?php   }?>
                                        </select>  
                                    </div>
                                </div>       
                            ...
                            <option selected disabled><--Select Status--></option>
                              <option style="color: green;" value="1" <?php echo (isset($edit) && !empty($edit) && $edit['payment_status']=='1') ? 'selected' : ''; ?>>Payment successful</option>
                              <option  style="color: red;" value="0" <?php echo (isset($edit) && !empty($edit) && $edit['payment_status']=='0') ? 'selected' : ''; ?>>Payment Failed</option>
                               <option  style="color: Orange;" value="2" <?php echo (isset($edit) && !empty($edit) && $edit['payment_status']=='2') ? 'selected' : ''; ?>>Payment Pending</option>
                            ...
                            <div class="col-lg-1">
                                ...
                                <div class="col-md-2">
                                    <a href="<?php echo site_url('getorderss'); ?>">
                       ...
                       <?php if($pagination["getNbResults"] >0 ){ ?>
                            ...
                            <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" data-sortable="true">Order ID</th>
                                        <th class="text-center"  data-sortable="true">Company<br>Name</th>
                                        <th class="text-center"  data-sortable="true">Customer<br>Name</th>
                                        <th class="text-center"  data-sortable="true">Product<br>Name</th>
                                        <th class="text-center"  data-sortable="true">Qty</th>
                                        <th class="text-center"  data-sortable="true">Discount</th>
                                        
                                        <th class="text-center"  data-sortable="true">Total<br>Amount</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        foreach ($list as $kdata) {
                                            ...
                                            <td class="text-center"><?php echo $kdata->order_id;?></td>
                                            <td class="text-center"><?php echo $kdata->company_name;?></td>
                                            

                                            <td class="text-center"><?php echo $kdata->name;?></td>
                        <td class="text-center"><?php echo $kdata->product_name; ?></td>
                        
                        
                            <td class="text-center"><?php echo $kdata->qty;?></td>
                            <td class="text-center"><?php echo $kdata->discount_percent;?></td>
                            <td class="text-center"><?php echo $kdata->total_amount;?></td>
                            <td class="text-center">
                            <?php if($kdata->payment_status=='1'){ $rec+=$kdata->total_amount;
                                $surediscount+=$kdata->discount_percent;?>
                        ...
                        <?php }?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('customerdetailsonline?id=' . $kdata->order_id); ?>">
                                                    <i class="ion ion-md-add-circle-outline"></i>
                                                </a>  

                                                <a class="btn btn-danger waves-effect waves-light" href="<?php echo site_url('OnlineShopping/delete?id=' . $kdata->order_id); ?>" onClick="return confirm('Are you sure you want to delete this item?');">
                                            ...
                                            <?php //$i+=$kdata->total_amount;?>                                         
                                            <?php $discount+=$kdata->discount_percent;?>                                         
...
<?php } ?>
                    ...
                    <br>
                    <table class="table size table-striped table-bordered m-top20">
                     <tbody>
                        <tr>
                         ...
                         <tr>
                           <th>Total Discount on Transaction Amount</th>
                           <td><span style="color:green;">OMR <?php echo number_format($discount, 3, '.', ''); ?></span></td>
                        </tr>
                        <tr>
                           <th>Total Received Amount</th>
                           <td><span style="color:green;">OMR <?php echo $rec; ?></span></td>
                        </tr>
                        <tr>
                           <th>Total Discount on Received Amount</th>
                           <td><span style="color:green;">OMR <?php echo number_format($surediscount, 3, '.', ''); ?></span></td>
                        </tr>
