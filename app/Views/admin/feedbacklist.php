            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="page-title-box">
                        <h4 class="font-size-20">Customer Feedback</h4>
                    </div>
                </div>
...
<form action="">
     <div class="col-xl-12">
         <div class="row">
                <div class="col-lg-4">
                         <input class="form-control" name="txtsearch" type="text" value="<?php echo $txtsearch; ?>" placeholder="Search by Username, Mobile Number, Enquiry" >
                    </div>
                    ...
                    <div class="card">
						...
						<?php if($pagination["getNbResults"] >0 ){ ?>
                            <div class="table-responsive">
                                <table data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="true" scope="col">Mobile Number</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo substr($kdata->enquiry,0,20) ; ?></td>                                      
                                            <td><?php echo $kdata->created_date ; ?></td>                                      
                                            <td>

                                                <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('FeedbackDetails?id='.$kdata->con_id); ?>">
                                                    <i class="ion ion-md-add-circle-outline"></i>
                                                </a> 

                                                <a class="btn btn-danger waves-effect waves-light" href="<?php echo site_url('DeleteFeedback?id='.$kdata->con_id); ?>" onClick="return confirm('Are you sure you want to delete this item?');">
                                ...
                                <br>
                               <?php echo view('admin/_paging', array('paginate' => $pagination, 'siteurl' => 'CustomerFeedback', 'varExtra' => $searchArray)); ?>
                                <?php } ?>
                            </div>
							<?php }else{ ?>
