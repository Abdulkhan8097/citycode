                    ...
                    <div class="card">                  
                        ...
                        <div class="row ">	                           
                            <div class="col-lg-3 ">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control" name="start_date" type="date" value="<?php if(!empty($searchArray['start_date'])) { echo $searchArray['start_date']; }?>" placeholder="Search by start date" >
                                </div>
                            </div>       
                         </div>								
                        ...
                        <div class="col-lg-3 ">
                            <div class="row">
								<label> End Date </label>
                                     <div class="col-md-12">
                                        <input class="form-control" name="end_date" type="date" value="<?php if(!empty($searchArray['end_date'])) { echo $searchArray['end_date']; } ?>" placeholder="Search by end adte" >
                                    </div>
                                </div>       
                            </div>
                            ...
                            <div class="row">
					            <label> Company Name </label>
                                    ...
                                    <?php
                                                    ...
                                                    <?php  if(!empty($searchArray['company_name'])){ if ($row['company_name'] == $searchArray['company_name']) {
                                                    echo $selected ; } else { echo $selected1; } }?>>
                                                    ...
                                                    <?php } else if($row["company_name"]) { ?>
                                                        <option value="<?php echo $row['company_name'] ?>" <?php  if(!empty($searchArray['company_name'])){ if ($row['company_name'] == $searchArray['company_name']) {
                                                    echo $selected ; } else { echo $selected1; } }?>><?php echo $row['company_name'];?></option>                                                    
                                                    <?php } else { ?>
									 <?php } } } else if ($session->get('company_id')) { ?>
                        ...
                        <div class="col-lg-3 ">
                            <div class="row">
								<label> Customer Mobile  </label>
                                    <div class="col-md-12">
                                        <input class="form-control" name="mobile" type="text" value="<?php if(!empty($searchArray['mobile'])) { echo $searchArray['mobile']; } ?>" placeholder="Search by customer mobile" >
                                    </div>
                                </div>       
                            </div>
								...
								<label> Gender </label>
                                   <div class="col-md-12">
                                    <select class="form-control" name="gender" >
                                        ...
                                        ?>
                                        <option value="Male" <?php if(!empty($male)) { echo $male; }?>> Male </option>
                                        <option value="Female" <?php if(!empty($female)) { echo $female; }?>> Female </option>
                                   </select>
                                </div>
                            </div>       
                        </div>
                        ...
                        <div class="col-lg-3 ">
                            <div class="row">
								<label> City Code </label>
                                    <div class="col-md-12">
                                        <input class="form-control" name="city_code" type="text" value="<?php if(!empty($searchArray['city_code'])) { echo $searchArray['city_code']; } ?>" placeholder="Search by city code" >
                                    </div>
                                </div>       
                            </div>
                        ...
                        <div class="col-lg-3 ">
                            <div class="row">
								<label> V.I.P Code </label>
                                    <div class="col-md-12">
                                        <input class="form-control" name="vip_code" type="text" value="<?php if (!empty($searchArray['vip_code'])) { echo $searchArray['vip_code']; } ?>" placeholder="Search by v.i.p code" >
                                    </div>
                                </div>       
                            </div>
                            ...
                            <div class="row">
								<label> Offer </label>
                                    ...
                                    <select class="form-control" name="coupon_type" >
                                        ...
                                        ?>
                                        <option value="city" <?php if(!empty($city)) { echo $city; }?>> Public Offer </option>
                                        <option value="vip" <?php if(!empty($vip)) { echo $vip; }?>> V.I.P Offer </option>
                                        <option value="friday" <?php if(!empty($friday)) { echo $friday; }?>> Friday Offer </option>
                                   </select>                                    
                                </div>
                              </div>       
                            </div>											                               
                        ...
                        <!--<div class="col-lg-3 ">
                            <div class="row">
								<label> Online Shop </label>
                                    <div class="col-md-12">
                                        <input class="form-control" name="online_shop" type="text" value="<?php if (!empty($searchArray['online_shop'])) { echo $searchArray['online_shop']; } ?>" placeholder="Search by online shop" >
                                    </div>
                                </div>       
                            </div>-->		 
				            ...
				            <label> Governorate </label>
                                <div class="col-md-12">
                                    ...
                                    <?php
                                                ...
                                                <?php  if(!empty($searchArray['stateid'])){ if ($row['state_id'] == $searchArray['stateid']) {
                                                    echo $selected ; } else { echo $selected1; } }?>><?php echo $row['state_name'];?></option>
                                    ...
                                    <option value="">Select State</option>
                                        ...
                                        ?>
                                            ...
                                            <option value="<?php echo $row['city_id'] ?>" 
                                                <?php  if(!empty($searchArray['cityid'])){ if ($row['city_id'] == $searchArray['cityid']) {
                                                    echo $selected ; } else { echo $selected1; } }?>><?php echo $row['city_name'];?></option>
        ...
        <div class="card-body">
				...
				<tbody>
                   ...
                   <tr>
                       ...
                       <td> <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('ReportDetails?id='.$session->get('company_id')); ?>">
                       <i class="ion ion-md-add-circle-outline"></i> </a> </td>
                   </tr>
               </tbody>
				   </table>
        ...
        <div class="card-body">
                 ...
                 <div class="table-responsive">
				  <?php  if($session->get('user_id')){ ?>
                    ...
                    <td><a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('ReportDetails?id='.$kdata->od_id); ?>">
                        <i class="ion ion-md-add-circle-outline"></i> </a></td>
                    </tr>
                    <?php } ?>
                </tbody>
