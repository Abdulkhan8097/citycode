...
<form action="">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        foreach ($companylist as $kdata) {
                                            ...
                                            <?php if($kdata['status']=='0'){?>
                                                <td ><?php echo 'InActive' ?></td>
                                           <?php }elseif($kdata['status']=='1'){ ?>
 ...
 <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModall" onclick="getorgList('<?php echo $kdata['id']; ?>');"><i class="ion ion-md-aperture"></i></button>                             
                                                <?php } else { ?> 
                                                <?php } ?>
                                            </td>  <?php } ?>                                          
                                        </tr>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="form-group row">
                ...
                <label for="inputPassword" class=" col-sm-4 col-form-label tens" style="color:#000 !important;"> Select All <input type="checkbox" class="selectall " /> </label>
            </div>
...
<div class="modal fade" id="myModall" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 style="color:#000 !important;"> Organization Code </h2>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
               
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-4 col-form-label tens" style="color:#000 !important;">&nbsp;&nbsp;Organization Name</label>
                <label for="inputPassword" class="col-sm-4 col-form-label tens" style="color:#000 !important;">ORG Code</label>
                 <label for="inputPassword" class=" col-sm-4 col-form-label tens" style="color:#000 !important;"> Select All <input type="checkbox" class="selectall " /> </label> 
               
            </div>
         
            <form class="custom-validation" id ="edit_model" method='post' action="CompanyController/add_org" enctype='multipart/form-data'>         
                <input type="hidden" id="id" name="id" >

                <div class="modal-body" id="divListorg">
...
<script>
 ...
 function getorgList(companyid)
        { 
                     var request = $.ajax( {
                            url : "<?php echo site_url('getorgcustomer?companyid='); ?>"+companyid,
                            cache: false,
                            contentType: false,
                            processData: false,
                            async: false,
