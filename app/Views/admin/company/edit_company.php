                 ...
                 <form class="custom-validation"  method='post' action="CompanyController/update" enctype='multipart/form-data'>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    <div class="col-sm-6">
                                     <input type="text" class="form-control" required placeholder="Enter location" name="c_location" value="<?php echo $companydetails->c_location;?>"/>
                                  </div>
                                </div>
                             </div>
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <?php if($companydetails->status == 0){ ?>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            <th data-sortable="true" class="text-center" scope="col">Sl. No.</th>
                                            <th data-sortable="true" class="text-center" scope="col">Start Date</th>
                                            <th data-sortable="true" class="text-center" scope="col">End Date</th>
											<th data-sortable="true" class="text-center" scope="col">Type</th>
                                            <th data-sortable="true" class="text-center" scope="col">Branch</th>
                                            <th data-sortable="true" class="text-center" scope="col">Company Discount</th>
                                           <th data-sortable="true" class="text-center" scope="col">Customer Discount</th> 
                                            <th data-sortable="true" class="text-center" scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <th  class="text-center"scope="row"><?php echo ++$i;?></th>
                                             <td  class="text-center"><?php echo date('d-m-Y',strtotime($kdata->start_date)); ?></td>
                                            <td  class="text-center"><?php echo date('d-m-Y',strtotime($kdata->end_date)); ?></td>
											<td  class="text-center"><?php echo $kdata->coupon_type; ?></td>
                                            <td  class="text-center"><?php foreach($branches as $bnch) { 
                                                    if ($bnch->branch_id == $kdata->branch_id) { 
                                              echo $bnch->branch_name; } } ?></td>
                                              <td  class="text-center"><?php echo $kdata->company_discount.' %'; ?></td>
                                              <td  class="text-center"><?php echo $kdata->customer_discount.' %'; ?></td>
                            ...
                            <div class="table-responsive">
                                <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            <th data-sortable="true" class="text-center" scope="col">Sl. No.</th>
                                             <th data-sortable="true" class="text-center" class="text-center" scope="col">Start Date</th>
                                            <th data-sortable="true" class="text-center" class="text-center" scope="col">End Date</th>
											<th data-sortable="true" class="text-center" scope="col">Type</th>
                                            <th data-sortable="true" class="text-center" scope="col">Branch</th>
                                              <th data-sortable="true" class="text-center" class="text-center" scope="col">Company Discount</th>
                                           <th data-sortable="true" class="text-center" class="text-center" scope="col">Customer Discount</th> 
                                            <th data-sortable="true" class="text-center" scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            <th class="text-center" data-sortable="true" scope="col">Sl. No.</th>
											                     
                                            <th class="text-center" data-sortable="true" scope="col">Branch Name</th>
                                            <th class="text-center" data-sortable="true" scope="col">Arabic Branch Name</th>
                                            <th class="text-center" data-sortable="true" scope="col">Authorized No.</th>
                                            <th class="text-center" data-sortable="true" scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <th class="text-center" scope="row"><?php echo ++$i;?></th>
                                            <td class="text-center"><?php echo $bnch->branch_name ; ?></td>
                                            <td class="text-center"><?php echo $bnch->arb_branch_name ; ?></td>
                                            <td class="text-center"><?php echo $bnch->branch_autho_no ; ?></td>
                                            <td class="text-center">
		...
		<h2> City code </h2>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
							 <form class="custom-validation" id="company_form"  method='post' action="CompanyController/addPublicoffer" enctype='multipart/form-data'>
               <input type="hidden" id="new_id" name="new_id" value="<?php echo $companydetails->id; ?>">
                             <div id="city_field"> 
      ...
      <div class="modal-content">
		...
		<h2> V.I.P Code </h2>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
             <form class="custom-validation"  method='post' action="CompanyController/addvip" enctype='multipart/form-data'>
               <input type="hidden" id="new_id" name="new_id" value="<?php echo $companydetails->id; ?>">          
		                 	<div id="famous_field">
                        <div class="form-group row">
                          <label for="inputPassword" class="col-sm-4 col-form-label">Branch<span class="mandatory">*</span></label>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<h2> Friday Code </h2>
          ...
          <div class="modal-body">
					<form class="custom-validation"  method='post' action="CompanyController/addFridayCode" enctype='multipart/form-data'>
                       <input type="hidden" id="new_id" name="new_id" value="<?php echo $companydetails->id; ?>"> 
			                  <div id="friday_field">
                           <div class="form-group row">
                            <label for="inputPassword" class="col-sm-4 col-form-label">Branch<span class="mandatory">*</span></label>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                    <form class="custom-validation"  method='post' action="CompanyController/addBranch" enctype='multipart/form-data'>
                            <input type="hidden" id="new_id" name="new_id" value="<?php echo $companydetails->id; ?>">
                               <div id="add_to_me"> 
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-4 col-form-label">Branch <span class="mandatory">*</span></label>
                                    <div class="col-sm-6">
                                      <input type="text" name="branch_name" class="form-control" required placeholder="Enter Branch Name"/><br>
                               ...
                               <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                     <input type="text" class="form-control" placeholder="Enter Username" name="branch_username" required/><br>
                                  </div>
                                </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
				                                <input type="password" id="pass22" class="form-control" placeholder="Password" required name="branch_password"/>
                                  </div>
                                </div>
                                 ...
                                 <div class="form-group row d-none"  id="ifYes">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Enter Amount" name="fast_delivery"/>
                                  </div>
                                </div> 
                                ...
                                <div class="form-group row d-none"  id="ifYes1">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Enter Amount" name="special_delivery"/>
                                  </div>
                                </div> 
        ...
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                                 ...
                                 <label for="inputPassword" class="col-sm-4 col-form-label"></label>
                                    <div class="col-sm-6">
                                        <button type="button" style="margin-bottom: 17px;" class="btn btn-primary waves-effect waves-light mr-1" id="owner-submit-btn" data-toggle="modal" data-target="#myModalbranch" data-dismiss="modal">
                                            Submit
                                        </button>
                                    </div>
                                </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                    <form class="custom-validation"  method='post' action="CompanyController/homeBusiness" enctype='multipart/form-data'>
                            <input type="hidden" id="new_id" name="new_id" value="<?php echo $companydetails->id; ?>">
